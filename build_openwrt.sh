...
# @example1     : bash build_openwrt.sh 手动输入密码
# @example2     : bash build_openwrt.sh password 自动输入密码
...
# 定义内核版本数组
KERNEL_VERSIONS=("$KERNEL_VERSION_DEFAULT" "5.15" "5.10" "5.4")
